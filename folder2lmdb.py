...
def folder2lmdb(dpath, name="train", write_frequency=5000):
    ...
    dataset = utils.CUB200_PIL(directory, './data/paintings_train.txt')
    data_loader = DataLoader(dataset, num_workers=16, collate_fn=lambda x: x)
    lmdb_path = osp.join('./data/paintings_train-lmdb', "%s.lmdb" % name)
...
if __name__ == "__main__":
    # generate lmdb
    folder2lmdb("/path/to/paintings/train/", name="paintings")
